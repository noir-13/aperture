...
<body class="">
  ...
  <section id="home" class="home w-100 min-vh-100 bg-dark position-relative d-flex justify-content-center align-items-center">
    ...
    <div class="container position-absolute text-center text-light d-flex align-items-center justify-content-center flex-column gap-3" id="homeText">
      ...
      <h1 class="display-1 w-75 fw-normal m-0 text-light">Capture Every Moment, Book Every Memory</h1>
      <div class="d-flex flex-column flex-md-row gap-3">
        <a href="booking.php" class="btn border-light px-4 text-light rounded">Book Now</a>
  ...
  <section class=" py-5 min-vh-100 w-100  position-relative">

    <div class="container justify-content-center px-4  mb-5">
      <div class="row g-lg-5 g-3 ">

        <div class="col-lg-6 ">

          <h2 class="fw-bolder">Finding the Perfect Photographer Shouldn't Be This Hard</h2>
          ...
          <ul class="list-unstyled">
            <li class="mb-2">
              <img src="./assets/x.png" class="me-2" alt="" style="width: 1.5rem; height: 1.5rem;">Endless searching through countless portfolios
            </li>

            <li class="mb-2">
              <img src="./assets/x.png" class="me-2" alt="" style="width: 1.5rem; height: 1.5rem;">Uncertainty about pricing and hidden fees
            </li>

            <li class="mb-2">
              <img src="./assets/x.png" class="me-2" alt="" style="width: 1.5rem; height: 1.5rem;">No real-time availability information
            </li>

            <li class="mb-2">
              <img src="./assets/x.png" class="me-2" alt="" style="width: 1.5rem; height: 1.5rem;">Difficulty comparing styles and specialties
            </li>

            <li class="mb-2">
              <img src="./assets/x.png" class="me-2" alt="" style="width: 1.5rem; height: 1.5rem;">Stress about delivery timelines and quality
            </li>
          </ul>
        ...
        <div class="col-lg-6 ">
          <img src="./assets/high-angle-photo-camera-indoors-still-life.jpg" alt="" class="img-fluid rounded" style="max-width:100%;max-height: 400px;">
        </div>
    ...
    <div class="container mt-5">
      <div class="row mb-5">
        <div class="text-center mx-auto col-lg-8">
          <h2 class="fw-bolder">Easy Booking for Photographers and Videographers</h2>
      ...
      <div class="row solutionGroup gap-3">
        <div class="card solutionCard  px-2 py-4 shadow border-0">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text text-secondary">We connect you with experienced photographers and videographers you can rely on.</p>
          </div>
        </div>
        ...
        <div class="card solutionCard px-2 py-4 shadow border-0">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text text-secondary">See all prices upfront with no hidden fees, so you can plan your budget easily.</p>
          </div>
        </div>
        ...
        <div class="card solutionCard  px-2 py-4 shadow border-0">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text text-secondary">Check availability and book your preferred professional instantly online.</p>
          </div>
        </div>
        ...
        <div class="card solutionCard  px-2 py-4 shadow border-0">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text text-secondary">Filter and compare creatives by style, specialty, and reviews to find your perfect match.</p>
          </div>
        </div>
        ...
        <div class="card solutionCard  px-2 py-4 shadow border-0">
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text text-secondary">We guarantee high-quality photos and videos delivered on schedule.</p>
          </div>
        </div>
  ...
  <section class="w-100 py-5  min-vh-100 d-flex justify-content-center align-items-center heroSectionService" id="services">
  ...
  <section id="features" class="px-2 py-5 features position-relative bg-white  w-100 min-vh-100 justify-content-center align-content-center">
    <div class="container">
    ...
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-md-8 text-center text-light">
          ...
          <p>Booking your perfect photographer or videographer has never been easier. Follow these simple steps to capture every moment and create lasting memories.</p>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row priceRow justify-content-center align-items-center gap-2">
        ...
        <div class="card col-md-4 py-3 px-2 rounded-4 justify-content-center align-items-center border-1 shadow">
          ...
          <div class="price d-flex justify-content-center align-content-center align-items-end gap-2">
            <h1 class="fw-bold text-dark">$90</h1>
            <p>/per hour</p>
          </div>
        ...
        <div class="card col-md-4 py-3 px-2 rounded-4 justify-content-center align-items-center border-1 shadow">
          ...
          <div class="price d-flex justify-content-center align-content-center align-items-end gap-2">
            <h1 class="fw-bold text-dark">$100 </h1>
            <p>/per hour</p>
          </div>
            ...
            <div class="row justify-content-center g-3" id="testimonialRow">
                <div class="col col-md-4">
                    <div class="card">
                                    ...
                                    <div class="card-body">
                                        <small class="text-secondary">"For our company launch, Aperture's style filters helped us pick the perfect videographer quickly. No hidden fees, and the Premium coverage ($100/hr) delivered polished videos in a week—our team loved the quality and ease!"</small>
                                    </div>
                                </div>
                </div> 
                   <div class="col col-md-4">
                    <div class="card">
                                    <div class="card-header d-flex justify-content-center align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-secondary">Client from Metro Manila</small>
                                        </div>

                                    </div>
                                    <div class="card-body">
                                        <small class="text-secondary">"Booking for my son's birthday was effortless—Aperture's 4-step process confirmed everything in hours. The Basic package ($80/hr) captured all the fun moments with quick edits. Affordable and reliable for family events!"</small>
                                    </div>
                                </div>
                </div>
                   <div class="col col-md-4">
                    <div class="card">
                                    ...
                                    <div class="card-body">
                                        <small class="text-secondary">"Aperture made booking a behind-the-lens session straightforward—no availability hassles or extra costs. The Premium pro ($100/hr) captured my portfolio perfectly with advanced edits. Trustworthy platform for aspiring creatives."</small>
                                    </div>
                                </div>
                </div>
            </div>
