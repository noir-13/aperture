                ...
                <div class="col border  shadow-sm px-3  py-5 position-relative secondCol">
                    ...
                    <div class="infoContainer">
                        ...
                        <div class="info mt-4 <?php echo ($activeMember == 'centino') ? 'active' : '' ?>" id="aboutCentino">
                            ...
                            <section class="p-3">
                                <h1 class="poppins">About me</h1>
                                <p class="m-0">I am a hardworking and goal-oriented student who is committed to continuous learning and self-improvement. I value discipline, responsibility, and teamwork as part of my personal and academic growth.</p>
                            </section>
